...
<source srcset="images/rye-buy320px.png" media="(max-width:400px)">

<source srcset="images/rye-buy480px.png" media="(max-width:720px)">

<source srcset="images/rye-buy760px.png" media="(max-width:999px)">

<source srcset="images/rye-buy760px.png" media="(max-width:1299px)">

<source srcset="images/rye-buy1366px.png" media="(min-width:1366px)">

<img src="images/rye-buy760px.png" title="Rye" alt="Rye">
...
<h5 class="smallsize" style="text-align:center;"> Rye</h5>
...
<form action="buybread - rye.php" method="post" class="buybread" oninput="price.value = b.value * c.value">
...
<input type="hidden" name="bread_type" value="Rye">
