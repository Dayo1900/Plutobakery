...
<source srcset="images/Englishmuffins-buy320px.png" media="(max-width:400px)">

<source srcset="images/Englishmuffins-buy480px.png" media="(max-width:720px)">

<source srcset="images/Englishmuffins-buy760px.png" media="(max-width:999px)">

<source srcset="images/Englishmuffins-buy760px.png" media="(max-width:1299px)">

<source srcset="images/Englishmuffins-buy1366px.png" media="(min-width:1366px)">

<img src="images/Englishmuffins-buy760px.png" title="English muffins" alt="English muffins">
...
<h5 class="smallsize" style="text-align:center;"> English muffins</h5>
...
<form action="buybread - englishmuffins.php" method="post" class="buybread" oninput="price.value = b.value * c.value">
...
<input type="hidden" name="bread_type" value="English muffins">
