...
<source srcset="images/zopf-buy320px.png" media="(max-width:400px)">

<source srcset="images/zopf-buy480px.png" media="(max-width:720px)">

<source srcset="images/zopf-buy760px.png" media="(max-width:999px)">

<source srcset="images/zopf-buy760px.png" media="(max-width:1299px)">

<source srcset="images/zopf-buy1366px.png" media="(min-width:1366px)">

<img src="images/zopf-buy760px.png" title="Zopf" alt="Zopf">
...
<h5 class="smallsize" style="text-align:center;">Zopf</h5>
...
<form action="buybread - zopf.php" method="post" style="width:100%;" oninput="price.value = b.value * c.value">
...
<input type="hidden" name="bread_type" value="Zopf">
