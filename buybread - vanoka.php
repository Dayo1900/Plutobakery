...
<source srcset="images/vanocka-buy320px.png" media="(max-width:400px)">

<source srcset="images/vanocka-buy480px.png" media="(max-width:720px)">

<source srcset="images/vanocka-buy760px.png" media="(max-width:999px)">

<source srcset="images/vanocka-buy760px.png" media="(max-width:1299px)">

<source srcset="images/vanocka-buy1366px.png" media="(min-width:1366px)">

<img src="images/vanocka-buy760px.png" title="Vanocka" alt="Vanocka">
...
<h5 class="smallsize" style="text-align:center;"> Vanocka</h5>
...
<form action="buybread - vanoka.php" method="post" class="buybread" oninput="price.value = b.value * c.value">
...
<input type="hidden" id="c" value=400> 
<input type="hidden" name="bread_type" value="Vanocka">
