...
<source srcset="images/multigrainbread-buy320px.png" media="(max-width:400px)">

<source srcset="images/multigrainbread-buy480px.png" media="(max-width:720px)">

<source srcset="images/multigrainbread-buy760px.png" media="(max-width:999px)">

<source srcset="images/multigrainbread-buy760px.png" media="(max-width:1299px)">

<source srcset="images/multigrainbread-buy1366px.png" media="(min-width:1366px)">

<img src="images/multigrainbreadbread-buy760px.png" title="Multigrain" alt="Multigrain">
...
<h5 class="smallsize" style="text-align:center;"> Multigrain</h5>
...
<form action="buybread - multigrain.php" method="post" class="buybread" oninput="price.value = b.value * c.value">
...
<input type="hidden" id="c" value=500> 
<input type="hidden" name="bread_type" value="Multigrain">
