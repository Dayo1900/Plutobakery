...
<source srcset="images/matzoh-buy320px.png" media="(max-width:400px)">

<source srcset="images/matzoh-buy480px.png" media="(max-width:720px)">

<source srcset="images/matzoh-buy760px.png" media="(max-width:999px)">

<source srcset="images/matzoh-buy760px.png" media="(max-width:1299px)">

<source srcset="images/matzoh-buy1366px.png" media="(min-width:1366px)">

<img src="images/matzoh-buy760px.png" title="Matzoh" alt="Matzoh">
...
<h5 class="smallsize" style="text-align:center;"> Matzoh</h5>
...
<form action="buybread - matzo.php" method="post" class="buybread" oninput="price.value = b.value * c.value">
...
<input type="hidden" id="c" value=30> 
<input type="hidden" name="bread_type" value="Matzoh">
